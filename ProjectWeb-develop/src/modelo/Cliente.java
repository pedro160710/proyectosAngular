...
public class Cliente implements Serializable {
	...
	@OneToMany(mappedBy="cliente", fetch = FetchType.EAGER)//fetch = FetchType.EAGER populate in json
	@JsonIgnore
	...
	public String toString() {
		return "Cliente [idCliente=" + idCliente + ", cliCedula=" + cliCedula + ", cliCorreo=" + cliCorreo
				+ ", cliDireccion=" + cliDireccion + ", cliMovil=" + cliMovil + ", cliNombre=" + cliNombre
				+ ", cliRazonSocial=" + cliRazonSocial + ", cliTelefono=" + cliTelefono + ", facturas=" + facturas
				+ "]";
	}
