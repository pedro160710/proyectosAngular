...
public class Factura implements Serializable {
	...
	@OneToMany(mappedBy="factura", fetch=FetchType.EAGER )//,cascade = CascadeType.ALL,fetch=FetchType.EAGER )
	@JsonIgnore
	...
	public String toString() {
		return "Factura [idFactura=" + idFactura + ", facEstado=" + facEstado + ", facFecha=" + facFecha + ", facIva="
				+ facIva + ", facNumero=" + facNumero + ", facSubtotal=" + facSubtotal + ", facTipo=" + facTipo
				+ ", facTotal=" + facTotal + ", detalleFacturas=" + detalleFacturas + ", cliente=" + cliente
				+ ", usuario=" + usuario + "]";
	}
