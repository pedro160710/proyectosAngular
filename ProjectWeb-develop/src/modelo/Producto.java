...
public class Producto implements Serializable {
	...
	public String toString() {
		return "Producto [idProducto=" + idProducto + ", pordCostoVentaFinal=" + pordCostoVentaFinal
				+ ", pordCostoVentaRef=" + pordCostoVentaRef + ", prodCodigo=" + prodCodigo + ", prodEstado="
				+ prodEstado + ", prodNombre=" + prodNombre + ", categoria=" + categoria + ", detalleFacturas="
				+ detalleFacturas + "]";
	}
