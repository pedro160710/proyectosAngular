...
<body>
	...
	<center>
		<th><a style="color: red; float: right:;"
			href="http://localhost:8080/ProjectWeb/nuevoproducto.jsp"> <input
				type=image src="imagenes/add.png" width="25" height="15"></a></th>
		<th><a style="color: red; float: right:;" target="_blank"
			href="ReportesCtlr?id=producto"> <input type=image
				src="imagenes/pdf.png" width="25" height="15"></a></th>
